  ...
  const steps = [
    {
      ...
      description: "Easily create databases by prompting our AI builder"
    },
    {
      number: "2",
      icon: <Rocket className="w-6 h-6" />,
      title: "Organize",
      description: "Organize your data with powerful views and filters"
    },
    {
      number: "3",
      icon: <Zap className="w-6 h-6" />,
      title: "Automate",
      description: "Connect your data to workflows with our integrations"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-700 font-semibold">
            From zero to organized databases in under 5 minutes
          </p>
        </div>
