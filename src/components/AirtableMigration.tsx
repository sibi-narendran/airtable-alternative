        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl font-black text-gray-900 mb-4">
              Migrate from Airtable Instantly
            </h2>
            
            <p className="text-lg text-gray-700 font-semibold mb-8 max-w-2xl mx-auto">
              Import all your bases, views, and data with one click. No rebuilding required.
            </p>
...
export default AirtableMigration;
